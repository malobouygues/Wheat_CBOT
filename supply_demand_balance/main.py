...
csv_path = os.path.join(script_dir, "data", "df_wasde_wheat.csv")
...
avg_since_label = f'Avg since {first_str}'

fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(10, 8), sharex=True)

ax1.plot(df_us_long['month'], df_us_long['stocks_to_use'], marker='o', linewidth=2, label=avg_since_label)
...
ax1.set_xlabel(month_label, fontsize=10)
...
ax2.plot(df_world_long['month'], df_world_long['stocks_to_use'], marker='o', linewidth=2, color='orange', label=avg_since_label)
